...
<div class="flex flex-col lg:flex-row flex-1 w-full mx-auto p-4 md:p-6 gap-6 relative z-10 max-w-[1600px]">
    ...
    <aside class="w-full lg:w-64 shrink-0 space-y-1">
        ...
        <div class="flex flex-col sm:flex-row lg:flex-col gap-1 sm:flex-wrap lg:flex-nowrap">
            ...
            <a href="my_donations.php" class="flex-1 sm:flex-initial flex items-center gap-3 px-4 py-2.5 rounded-xl text-slate-600 hover:bg-white hover:text-emerald-600 border border-transparent hover:border-slate-200/50 transition duration-150 font-medium text-sm">
